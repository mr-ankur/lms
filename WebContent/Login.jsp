...
<% String message = (String)request.getAttribute("alertMsg");
                if(message!=null && message=="username or password is incorrect"){
                out.print(message+"</br></br>");
                out.print("Forgot <a href=\"Forgot.jsp\">Password ?</a></br>");
                }
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="log.jsp" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="res/avatar.jfif" alt="Avatar" class="avatar">
    </div>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content" action="Signup.jsp" method="post">
    <div class="container">
      ...
      <input type="text" placeholder="Enter Your Phone Number" name="phnum" required>
      
      <label for="uname"><b>Username</b></label>
      <input type="text" placeholder="Enter Username" name="uname" required>
      
      <label for="add"><b>Address</b></label>
      <input type="text" placeholder="Enter Your Address Here" name="add" required>
