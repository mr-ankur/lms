		         ...
		         <section class="head" style="height:104px;width:200vh;-webkit-user-select:none;">
		          ...
		          <div class="image2" style="margin-left:957px;margin-top:-75px;"><img class = "image2" style="height:130px;width:250px;" src ="res/Swachh_Bharat_Logo.png"></div>
		               ...
		               <section class="hero" style="background-color:#F1F3EA;background-size:cover;height:100vh;width:200vh;">
					   	  ...
					   	  <div style="text-align:center;padding-top:18px;font-size:12px;"><h1 style="color:#8F8888;"><hr width="50%" size="5"/>File Your Complaint Here<hr width="50%" size="5"/></h1>
						<img class = "image3" style="height:230px;width:380px;border-radius:7px;margin-left:-800px;margin-top:9%;position:relative;-webkit-user-select:none;outline:none;" src ="res/complaint.png">
						  
						  <form class="Complaint" method="" action="">
						  
						  
						  <p style="margin-left:-190px;font-size:18px;margin-top:-320px;margin-bottom:-0px;-webkit-user-select:none;">User ID</p><input type="text" style="height:20px;width:250px;border:1px solid;margin-left:-8px;padding:16px;opacity:.8;border-radius:4px;outline:none;" placeholder="Please Enter Your User ID">
						  
						  <p style="margin-left:500px;font-size:18px;margin-top:-60px;margin-bottom:-0px;-webkit-user-select:none;">Password</p><input type="Password" style="height:20px;width:250px;border:1px solid;margin-left:670px;padding:16px; opacity:.8;border-radius:4px;outline:none;" placeholder="Please Enter Your Password">
                           </br></br></br>
						  <label style="font-size:18px;margin-left:-40px;-webkit-user-select:none;">Describe Your Problem:</label></br> <textarea name="complaint" rows="12" cols="70" style="margin-left:330px; padding:5px;resize:none;" Placeholder="*We Are Happy To Help You !"></textarea>
						  
						  <button href="" type="button" style="margin-left:690px;margin-top:10px;border-radius:5px;outline:none;width:230px;height:45px;">Submit</button>
						  </br></br>
						  <p style="color:#EF271F;">*We are suggested you to please check your above information, before submit your complaint.</p>
						  <p style="color:#EF271F;">*We are also suggested you to please use LMRC Helpline Number for regarding any help.</p>
					   </form>
		          ...
		          <section class="foot" style="margin-top:-13vh;">
					  <div class="footer"> <div class="h6"><h6 style="position:absolute; margin-top:-30px; font-size:19px;">LET'S STAY IN TOUCH</h6><h6 style="margin-top:-5px; pointer-size:10px;">( Get updates on important informations and more )</h6>
					   ...
					   <p style="font-size:18px;margin-left:1080px;margin-top:-10px;color:#FEE2B6;position:absolute; -webkit-user-select:none;">[9:30 AM to 6:00 PM (Mon-Sat)]</p>
