<html>
     ...
     <head>
	 <meta charset="utf-8">
      <title>LMRC/Recharge Your Smart MetroCard</title>
...
<body>         
		         ...
		         <section class="head" style="height:104px;width:200vh;-webkit-user-select:none;">
		          ...
		          <div class="image2" style="margin-left:957px;margin-top:-75px;"><img class = "image2" style="height:130px;width:250px;" src ="res/Swachh_Bharat_Logo.png"></div>
		               ...
		               <section class="hero" style="background-color:#F1F3EA;background-size:cover;height:115vh;width:200vh;">
				      	  <div style="text-align:center;padding-top:18px;font-size:12px;"><h1 style="color:#8F8888;"><hr width="100%" size="5"/> Recharge Your Smart Metro Card<hr width="100%" size="5"/></h1>
						  ...
						  <p style="margin-left:-540px;font-size:18px;margin-top:px;margin-bottom:3px;-webkit-user-select:none;">MetroCard Number</p><input type="text" style="height:20px;width:315px;border:1px solid;margin-left:-377px;padding:16px;opacity:.8;border-radius:4px;outline:none;" placeholder="Please Enter Your MetroCard Number">
						  </br>
						  
						  <p style="margin-left:190px;font-size:18px;margin-top:-60px;margin-bottom:-0px;-webkit-user-select:none;">Amount</p><input type="text" style="height:20px;width:315px;border:1px solid;margin-left:440px;padding:16px;opacity:.8;border-radius:4px;outline:none;" placeholder="Please Enter Amount In Rupee(s)">
						  </br>
						  <button href="" type="button" style="margin-left:550px;margin-top:20px;border-radius:5px;outline:none;width:200px;height:35px;">Recharge</button>
						  </form>
						  </br>
	     				 <p style="color:#EF271F;">*After submit Your Request we are re-directed to our transaction site, please fill your information correctly.</p>
						   <p style="color:#EF271F;">*Please fill information carefully, amount is not re-transferable.</p>
						  <p style="color:#EF271F;">*You can see your transaction details below after completing transaction.</p>
