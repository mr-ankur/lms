...
<html Lang="en">
     ...
     <body>
	     ...
	     <h1>WELCOME TO LUCKNOW METRO RAIL CORPORATION LIMITED (LMRCL) LITE WEBSITE!<h1>
				 ...
				 <div class="login">
				 <div class="LOG_IN" ><a class="btn homn_btn" style="width:97.8%; margin:5px;" href="Login.jsp">

                               <i class="fa fa-address-card" style="COLOR:WHITE;font-size:30px;"></i> LOG IN
                               

                              </a></div>
				 <div class="SIGN_UP"><a class="btn homn_btn" style="width:97.8%; margin:5px;" href="Login.jsp">

                               <i class="fa fa-edit" style="COLOR:WHITE;font-size:30px;"></i> SIGN UP
                               

                              </a></div>
				 <div class="FARE & TICKETS"><a class="btn homn_btn" style="width:97.8%; margin:5px;" href="FareAndTicket.jsp">

                               <i class="fa fa-inr" style="COLOR:WHITE;font-size:30px;"></i> FARE & TICKETS
				 ...
				 <div class="REGISTER GOSMART CARD"><a class="btn homn_btn" style="width:97.8%; margin:5px;" href="Login.jsp">

                               <i class="fa fa-credit-card-alt" style="COLOR:WHITE;font-size:30px;"></i> REGISTER GOSMART CARD
		             ...
		             <section class="middle">
					   ...
					   <div class="content" style="margin-top: -415px;margin-left:700px;height:600px;width:440px;">
					    ...
					    <a href="CheckMetroSchedule.jsp" class="button-hover" style="height:45px;width:400px;background-image:url(res/schedule.jpg)"> <i class="fa fa-calendar-check-o" style="font-size:40px;magin-left:50px;"> </i><span style="margin-left:20px;">Check Schedule </span></a>
						<a href="http://www.lmrcl.com/passengerinfo/latest-updates/" class="button-hover1" style="height:45px;width:400px;margin-top:8px;background-image:url(res/newss.jpg);"> <i class="fa fa-newspaper-o" style="font-size:40px;magin-left:50px;"> </i><span style="margin-left:20px;">NEWS & Notice Box </span></a>
                        <a href="http://www.lmrcl.com/media/image-gallery/" class="button-hover2" style="height:45px;width:400px;margin-top:8px;background-image:url(res/download.jpg)"><i class="fa fa-image" style="font-size:40px;magin-left:50px;"> </i><span style="margin-left:20px;">Image  Gallery </span></a>
                        <a href="http://www.lmrcl.com/media/video-gallery/" class=" button-hover3" style="height:45px;width:400px;margin-top:8px;background-image:url(res/lmrc-jobs-copy.jpg)"><i class="fa fa-video-camera" style="magin-left:50px;font-size:40px;"> </i><span style="margin-left:20px;">Video Gallery </span></a>
